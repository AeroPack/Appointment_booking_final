...
export function Tags() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] font-body-base text-[#191c1e] flex flex-col lg:h-screen lg:overflow-hidden antialiased">
      <div className="flex-1 w-full max-w-[1400px] mx-auto flex flex-col px-4 pt-6 lg:px-8 lg:pt-8 overflow-hidden">
      ...
      <Dialog
        open={dialogOpen}
        onOpenChange={(open) => { if (!open) resetForm(); else setDialogOpen(true); }}
        ...
        <form className="space-y-6" onSubmit={e => { e.preventDefault(); handleSave(); }}>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="w-full h-[48px] bg-[#f7f9fb] border-[#e0e3e5] focus-visible:ring-[#005c55] text-[16px] rounded-xl px-4"
            />
          </div>
            ...
            <div className="flex flex-wrap gap-3">
              {TAG_COLORS.map(color => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full transition-all ${COLOR_CLASSES[color]} ${
                    activeColor === color
          ...
          <div className="pt-2">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[12px] text-[#6e7977] mt-0.5">Apply tag based on patient behavior</p>
              </div>
            ...
            <div className={`transition-all duration-300 overflow-hidden ${isAutoAssign ? 'opacity-100 max-h-[500px]' : 'opacity-0 max-h-0 pointer-events-none'}`}>
              <div className="bg-[#f7f9fb] border border-[#e0e3e5] border-dashed rounded-xl p-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label className="text-[12px] font-semibold text-[#6e7977]">IF</label>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <Button type="button" variant="outline" onClick={resetForm} className="px-8 h-12 border-[#bdc9c6] text-[#3e4947] hover:bg-[#f2f4f6] rounded-full font-semibold text-[14px] transition-colors">
              Cancel
            </Button>
          </div>
        </form>
